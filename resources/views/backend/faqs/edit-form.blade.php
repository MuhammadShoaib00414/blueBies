<div class="card-body">
    ...
    <hr>
    @php
        // Assuming $faq is your model instance
        $localizationData = json_decode($faq->localization, true);
    @endphp
    <div class="row mt-4 mb-4">
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    {{ Form::text('localization[]', $localizationData['ar']['name'] ?? null, ['class' => 'form-control', 'placeholder' => trans('Enter Question in English'), 'required' => 'required']) }}
                </div>
                <!--col-->
            </div>
            <!--form-group-->
            ...
            <div class="form-group row">
                ...
                {{ Form::label('localization', trans('Enter Answer in Arabic'), ['class' => 'col-md-2 from-control-label required']) }}
                    ...
                    <div class="col-md-4">
                        {{ Form::text('localization[]', $localizationData['ar']['answer'] ?? null, ['class' => 'form-control', 'placeholder' => trans('Enter Question in Arabic'), 'required' => 'required']) }}
                    </div>
                    <!--col-->
            </div>
            <!--form-group-->
