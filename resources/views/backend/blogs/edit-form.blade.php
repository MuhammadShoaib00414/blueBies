<div class="card-body">
    ...
    @php
        ...
        $localizationData = json_decode($blog['localization'], true, 512, JSON_UNESCAPED_UNICODE);
    ...
    <div class="row mt-4 mb-4">
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    {{ Form::text('localization[]', $localizationData['ar']['title'] ?? null, ['class' => 'form-control', 'placeholder' => trans('Blog In Arabic'), 'required' => 'required']) }}
                </div>
                <!--col-->
            </div>
            <!--form-group-->
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    {{ Form::textarea('localization[]', $localizationData['ar']['content'] ?? null, ['class' => 'form-control', 'placeholder' => trans('Content In Arabic')]) }}
                </div>
                <!--col-->
            </div>
            <!--form-group-->
